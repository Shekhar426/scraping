                ...
                while max_retries:
                    ...
                    try:
                        if response.status_code == 200:
                            ...
                            with open(f'/usr/src/app/json_rh/output/{args.start}/rhapiSuccess.txt', 'a') as f:
                                f.write(prod)
                                f.write('\n')
                            break
                        else:
                            ...
                            if max_retries==0:
                              ...
                              with open(f'/usr/src/app/json_rh/output/{args.start}/rhapiError.txt', 'a') as f:
                                    f.write(prod)
                                    f.write('\n')
...
file_path = f'/usr/src/app/12/rh_all.json'
